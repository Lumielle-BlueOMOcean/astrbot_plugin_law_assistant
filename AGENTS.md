...
- The Phase 0.4A structured-material v1 module is validation/preview only: it must preserve block order, locators and provenance, never write the database, and never grant verified-real-question or official-case identity.
